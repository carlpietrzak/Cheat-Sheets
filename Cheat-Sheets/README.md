...
- [Git Cheat Sheet #2](Git-Cheat-Sheet.pdf)


## Jupyter Notebook
- [Jupyter Notebook Cheat Sheet](Jupyter-Notebook-Cheat-Sheet.pdf)

- [Markdown Cheat Sheet #1](Markdown-Cheat-Sheet.md)

- [Markdown Cheat Sheet #2](Markdown-Cheat-Sheet.pdf)


## General Python
- [Begginer's Python Cheat Sheet](Begginers-Python-Cheat-Sheet.pdf)

- [Python 3 Quick Reference Guide](Python-3-Quick-Reference-Guide%20.pdf)

- [Python Basics Cheat Sheet #1](Python-Basics-Cheat-Sheet%20.pdf)
...
### NumPy
- [NumPy Cheat Sheet #1](Numpy-Basics-Cheat-Sheet.pdf)
...
- [Pandas Cheat Sheet #1](Pandas-Cheat-Sheet.pdf)
...
- [Bokeh Cheat Sheet](Bokeh-Cheat-Sheet.pdf)


## Machine Learning
- [Scikit Learn Cheat Sheet](Scikit-Learn-Cheat-Sheet%20.pdf)

- [Scikit Learn Algorithms](Scikit-Learn-Algorithms.png)
...
- [SciPy Cheat Sheet](SciPy-Cheat-Sheet.pdf)
